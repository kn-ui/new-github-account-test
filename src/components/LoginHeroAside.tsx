  ...
  return (
    <aside className="hidden lg:block w-1/2 bg-[#0e4fb9] relative overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        <img src="/hero-school.jpg" alt="Campus" className="w-full h-full object-cover" />
      </div>
      <div className="relative z-10 h-full flex flex-col justify-center p-16 text-white">
        ...
        <div className="mt-8">
          <Link to="/courses" className="inline-flex items-center gap-2 bg-white text-[#0e4fb9] px-4 py-2 rounded-md font-semibold">
