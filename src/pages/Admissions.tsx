    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-[#13A0E2] text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
          ...
          <p className="text-xl mb-8">Registration Requirements</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-lg border p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Extension, Online and Regular</h2>
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
              {extOnlineRegular.map((item, idx) => (<li key={idx}>{item}</li>))}
            </ul>
          </div>
          <div className="bg-white rounded-lg border p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Children and Adolescent</h2>
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
        ...
        <div className="bg-white rounded-lg border p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Youth</h2>
          <ul className="list-disc pl-5 space-y-2 text-gray-700">
